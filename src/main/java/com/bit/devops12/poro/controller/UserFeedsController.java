...
//    }
    ...
    public String userFeeds(Model model, HttpSession session/*UserDto userdto */, @RequestParam(name = "id") int id) {
//        model.addAttribute("user",)
        ...
        model.addAttribute("portfolio",userFeedsService.getUserPortfolio(id));
        userFeedsService.getUserPortfolio(id).forEach(x->{
