                ...
                success:(obj)=>{
                    ...
                    if (obj.portfolioList) {
                        for (let i=0; i<obj.portfolioList.length; i++){
                            let regdate = new Date(obj.portfolioList[i].regdate);
                            let formattedDate = regdate.getFullYear() + '-' + ('0' + (regdate.getMonth() + 1)).slice(-2) + '-' + ('0' + regdate.getDate()).slice(-2);
                            htmlStr += `
                                <div class="col-sm-12 col-lg-6 col-xxl-4 grid-item">
                                    <div class="card">
                                        <div class="card-header">
                                        ...
                                        `;
                                if(${obj.isOwner}){
                                    htmlStr+=`<input type="checkbox" class="delete-dot" value="\${obj.portfolioList[i].portfolio_id}>`;
                                }
                                htmlStr+=`
                                        <a href="/feed-detail.do" id="iframe${obj.portfolioList[i].portfolio_id}">
                                            ...
                                            <iframe srcdoc="\${obj.portfolioList[i].srcdoc}" class="card-iframe ratio ratio-1x1" style="display:none" id="iframe\${obj.portfolioList[i].portfolio_id}"></iframe>
                                        </a>
                                        <div class="card-body">
                                            <p class="card-text">
                                        ...
                                        <div class="card-footer">
                                            <small class="text-body-secondary">
                                                \${formattedDate}
<%--                                            <javatime:format value="" pattern="yyyy-MM-dd"/>--%>
                                            </small>
                                        </div>
                                    </div>
                                </div>
...
<%--                                </c:choose>--%>
                                ...
                                <%--<p><javatime:format value="\${obj.recruitmentList[i].dday}" pattern="yyyy-MM-dd"/></p>--%>
